...
public class DESDemo {
	...
	public String hexDecimalToString(String hex)
	{
		...
		{
			String bin = new HexaDecimalToBinary().getBoolean(hexGroup[i]);
			result.append((char)new BinaryToDecimal().getDecimal(bin));
		}
		return result.toString();
	}
	...
	public String sBoxSelection(String data[])
	{
		...
		{			
			...
			for(int i=0;i<8;i++)
			{
				...
				int row = new BinaryToDecimal().getDecimal(rowData);
	...
	public String encrypt(String msg,String key)
	{
		...
		String encryptedHexadecimalMsg = new BinaryToHexaDecimal().getHexaDecimal(encryptedBinaryMsg);
